...
const Hero = () => {
  return <section className="h-[492px] md:h-[550px] lg:h-[700px] flex items-center relative overflow-hidden [mask-image:linear-gradient(to_bottom,transparent,black_10%,black_90%,transparent)]"
  ...
  >
    ...
    <div className="absolute h-64 w-64 md:h-72 md:w-72 lg:h-80 lg:w-80 rounded-full bg-purple-500 border border-white/20 top-1/2 left-1/2  -translate-x-1/2 -translate-y-1/2 inset-0 -z-[1] bg-[radial-gradient(50%_50%_at_16.8%_18.3%,white,rgb(184,148,255)_37.7%,rgb(24,0,66))] shadow-[-20px_-20px_50px_rgb(255,255,255,.5),-20px_-20px_80px_rgb(255,255,255,.1),0_0_50px_rgb(140,69,255)]"></div>

    {/* ring of satellites */}
    <div className="absolute h-[344px] w-[344px] md:h-[400px] md:w-[400px] lg:h-[512px] lg:w-[512px] border opacity-20 rounded-full top-1/2 left-1/2 -translate-y-1/2 -translate-x-1/2">
    ...
    {/* dotted ring  */}
    <div className="absolute h-[444px] w-[444px] md:h-[500px] md:w-[500px] lg:h-[612px] lg:w-[612px] border rounded-full top-1/2 border-white/20 border-dotted left-1/2 -translate-y-1/2 -translate-x-1/2"></div>

    {/* outer ring big */}
    <div className="absolute h-[544px] opacity-20 w-[544px] md:h-[600px] md:w-[600px] lg:h-[712px] lg:w-[712px] border rounded-full top-1/2 border-white left-1/2 -translate-y-1/2 -translate-x-1/2">
      <div className="absolute h-2 w-2 top-1/2 left-0 rounded-full bg-white -translate-x-1/2 -translate-y-1/2"></div>
    ...
    <div className="container flex justify-center flex-col items-center gap-5 text-center mt-16 z-10">
      ...
      <p className="text-lg md:text-xl text-white/70 max-w-xl mx-auto">
        Elevate your site's visibility with AI, where smart technology meets user-friendly SEO tools.
      </p>
      <GradientBtn>
        Join Waitlist
      </GradientBtn>
